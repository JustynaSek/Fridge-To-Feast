        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 sm:p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 gap-4">
          ...
          <div className="flex flex-wrap gap-2 order-1 sm:order-3 w-full sm:w-auto justify-center sm:justify-end">
            ...
            <button
              ...
              className="px-2 sm:px-3 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-xs shadow-sm"
            >
              <span className="hidden sm:inline">{t('savedRecipes.import')}</span>
            ...
            <button
              ...
              className={`px-2 sm:px-3 py-2 rounded-lg transition-colors text-xs shadow-sm ${
                savedRecipes.length === 0
                  ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                  : 'bg-green-500 text-white hover:bg-green-600'
              }`}
            >
              <span className="hidden sm:inline">{t('savedRecipes.export')}</span>
              <span className="sm:hidden">📤</span>
            </button>
            ...
            >
              <span className="hidden sm:inline">{t('savedRecipes.clearAll')}</span>
            ...
            <button
              onClick={onClose}
              className="px-3 sm:px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-600 bg-white dark:bg-gray-600 shadow-sm"
            >
